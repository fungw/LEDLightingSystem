/*
	...
	***************************************************************************
	...
	Modifications for LPC2468 port by Jonathan Dukes (jdukes@scss.tcd.ie)
*/
...
#define portTIMER_VIC_PRIORITY      ( ( uint32_t ) 0x0000 )
...
uint32_t ulCompareMatch;
	...
	ulCompareMatch = configPERIPHERAL_CLOCK_HZ / configTICK_RATE_HZ;
	...
	{
		VICVectAddr4 = ( uint32_t ) vPreemptiveTick;
	}
	#else
	{
		VICVectAddr4 = ( uint32_t ) vNonPreemptiveTick;
	}
	#endif

	/* Set VIC vector priority for pre-emptive tick interrupt */
	VICVectPriority4 = portTIMER_VIC_PRIORITY;
