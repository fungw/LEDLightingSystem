...
#define serU0VIC_PRIORITY				( ( unsigned long ) 8 )

/* Misc. */
#define serINVALID_QUEUE				( ( xQueueHandle ) 0 )
#define serHANDLE						( ( xComPortHandle ) 1 )
#define serNO_BLOCK						( ( portTickType ) 0 )
#define serMAX_BLOCK					( ( portTickType ) 1000 )
...
xComPortHandle xSerialPortInitMinimal( unsigned long ulWantedBaud, unsigned portBASE_TYPE uxQueueLength )
{
	  ...
	  )
	{
		portENTER_CRITICAL()
		{
			...
			ulDivisor = configPERIPHERAL_CLOCK_HZ / ulWantedClock;
			...
			VICVectAddr6 = ( unsigned long ) vUART_ISREntry;
			VICVectPriority6 = serU0VIC_PRIORITY;
...
signed portBASE_TYPE xSerialGetChar( xComPortHandle pxPort, char *pcRxedChar, portTickType xBlockTime )
{
...
void vSerialPutString( xComPortHandle pxPort, const char * const pcString, unsigned short usStringLength )
{
	...
	while( *pxNext )
	{
/*		xSerialPutChar( pxPort, *pxNext, serMAX_BLOCK );*/
...
signed portBASE_TYPE xSerialPutChar( xComPortHandle pxPort, char cOutChar, portTickType xBlockTime )
{
